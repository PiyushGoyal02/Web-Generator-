        ...
        if(event.key === "Enter"){
            try{
                ...
                const updateData = newData.tiles.map((val) => ({
                    ...val,
                    img_url: externalImgUrls[val.name]
                }));
